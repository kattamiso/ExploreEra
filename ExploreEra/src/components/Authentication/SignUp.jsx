      ...
      <div className="flex-grow flex flex-col justify-center items-center bg-[#F6F6F6] min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center bg-white p-5 rounded-lg shadow-md" style={{ marginTop: '10vh', width: '500px', maxWidth: '90%' }}>
          ...
          <div className="mb-4 w-full px-4">
            ...
            <input type="password" id="confirmPassword" name="confirmPassword" className="border border-orange-500 rounded p-2 w-full" required placeholder="Confirm your password"/>
          </div>
          <button type="submit" className="text-white bg-orange-500 px-4 py-2 rounded w-full hover:bg-orange-600 transition-colors">Sign Up</button>
          ...
          <div className="w-full text-center p-4">
            ...
            <p onClick={toggleModal} className="inline-block align-middle">
              By signing up, you agree with our <span className="text-[#C85100]" >Terms & conditions</span> and <span className="text-[#C85100]">Privacy policy</span>
            </p>
          </div>
        </form>
      </div>
      ...
      {modal && (
        <div className="bg-black bg-opacity-50 flex justify-center items-center" style={{ position: 'absolute', top: '0', left: '0', width: '100%', height: '100%' }}>       
           <div className="bg-white p-5 rounded-lg shadow-lg" style={{ width: '600px', maxWidth: '90%' }}>
            <h2 className="text-xl font-semibold mb-4">Welcome to SignUp Modal</h2>
            <p className="mb-4">
