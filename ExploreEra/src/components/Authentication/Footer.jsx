import { FooterIcons, Links } from "../Footer/FooterData"; 
import Vector from "../../../public/Img/Vector.png"
const Footer = () => {
  return (
    <div className="relative bottom-0 w-full h-[850px] md:h-[400px] bg-gray-200 p-12 flex flex-col md:flex-row justify-around">
