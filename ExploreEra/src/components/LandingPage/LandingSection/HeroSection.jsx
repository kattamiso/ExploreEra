  ...
  return (
    <div>
      ...
      <div className="absolute inset-0 h-[800px]" style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }}></div>
        ...
        <img src={BackgroundImg} alt="background image" className="object-cover h-[800px] w-screen" />

     <div className="absolute inset-0 flex justify-center items-center">
          <div className="text-center text-white">
            <h2 className="text-4xl font-semibold">Visit Mountains In <br /><span className="text-6xl space-x-2 tracking-wide">ITALY</span> </h2>
